(function() {
    ...
    d = {
        ...
        setStorage: function(a, b) {
            this._storage.transaction(function(d) {
                d.executeSql("SELECT v FROM SessionStorage WHERE k = ?", [a],
                function(d, c) {
        ...
        getStorage: function(a, b) {
            this._storage.transaction(function(d) {
                v = d.executeSql("SELECT v FROM SessionStorage WHERE k = ?", [a],
                function(a, d) {
        ...
        _createTable: function() {
            this._storage.transaction(function(a) {
                a.executeSql("SELECT COUNT(*) FROM SessionStorage", [],
                function() {},
                function(a) {
    ...
    BrowserStore = new Class({
        initialize: function() {
            this.storage = d.init() || c.init() || a.init() || b.init() || e;
            return this
        },
        set: function(a, b) {
...
var fixImageSize = function(a, c) { (a || a.length) && Array.from(a).each(function(a) {
...
function updateCartInfo() {
    ...
    try { (a || 0 === a) && $$(".op-cart-number").set("text", a),
        (c || 0 === c) && $$(".op-cart-count").set("text", c),
        (b || 0 === b) && $$(".op-cart-total").set("text", b)
    } catch(d) {}
} (function() {
    browserStore = null;
    withBrowserStore = function(a) {
        ...
        window.addEvent("domready",
        function() { (browserStore = new BrowserStore) ? a(browserStore) : window.addEvent("load",
            function() {
...
var priceControl = {
    ...
    format: function(a, c) {
        ...
        for (var g = []; 0 < e;) if (2 < e) e -= 3,
        g.unshift(a.substr(e, 3));
        else {
...
function bindDatepicker(a) {
    ...
    if (a.length) try {
        $LAB.script(c + "/datepicker.js").wait(function() {
            a.each(function(a) {
                var b;
                try {
...
function() {
    ...
    b = function(b, c, d) {
        ...
        if (c && !b.hasClass("fav-on")) {
            ...
            if (d) return e(j);
            b = b.get("_type") ? b.get("_type") : "goods"; (new Request({
                url: a,
                onRequest: function() {
                    this.FAVHTML = j.innerHTML;
                    j.innerHTML = '<span class="fav-loading">\u6536\u85cf\u4e2d...</span>'
                },
                onSuccess: function(a) { (a = JSON.decode(a)) && a.success ? (j.innerHTML = '<span class="fav-success"><q class="icon">&#x25;</q> \u6536\u85cf\u6210\u529f</span>', e.delay(2E3, this, j)) : j.innerHTML = this.FAVHTML
                }
            })).post({
                type: b,
                gid: c
    ...
    d = function(b, c, d) {
        ...
        if (c) {
            if (d) return e();
            d = b.get("data-type") ? b.get("data-type") : "goods"; (new Request({
                url: a,
                onRequest: function() {
                    this.FAVHTML = b.innerHTML;
...
function starGrade(a, c, b) {
    ...
    a && a.getElements(b || ".scores-item").each(function(a) {
        ...
        c || 0 === c ? (b.className = "stars stars-" + c, h.set("text", c), f.value = c) : (b.addEvent("mouseleave",
        function() {
            var a = f.value;
